...
const ICONS = {
  ...
  crown:  '<svg class="ico" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M3 8.4l3.6 2.7L10.4 5l3.2 6.1L17.4 8.4 20 18H4z" opacity="0.95"/><circle cx="3" cy="7" r="1.5"/><circle cx="21" cy="7" r="1.5"/></svg>',
  ...
  bell:   '<svg class="ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4a5 5 0 0 0-5 5v3.2L5.5 15.5h13L17 12.2V9a5 5 0 0 0-5-5z"/><path d="M10 18.2a2 2 0 0 0 4 0"/></svg>',
